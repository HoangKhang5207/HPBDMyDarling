const contentLetterSrart_actived = "CHÚC BÉ IUUU CỦA CHỒNGGGG SINH NHẬT VUI VẺ, CỤC CƯNGGG HÃY MỞ BỨC THƯ NÀY III:>>." //Lời mở đầu cho bức thư
const mainContentLetter = `
Gửi EM BEEE, Chúc mừng sinh nhật cô gái tuyệt vời nhất trong lòng anh! ❤️ 
Mong em beee luôn cười thật tươi, hạnh phúc mỗi ngày, và mãi là ánh nắng xinh đẹp, đáng yêu và dễ thương nhất của cuộc đời anh. 
Cảm ơn em beee đã đến bên anh, làm mọi khoảnh khắc trở nên ý nghĩa hơn. 
YÊU EM BEEE NHIỀU LẮM, CÔ CÔNG CHÚA BEEE NHỎ CỦA ANH! 🎂🌸✨`; //Nội dung của bức thư
